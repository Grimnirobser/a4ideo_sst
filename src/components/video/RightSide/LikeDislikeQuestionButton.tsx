...
interface LikeDislikeQuestionButtonProps {
  video: Video;
}


// TODO: change video to problemset

const LikeDislikeQuestionButton: React.FC<LikeDislikeQuestionButtonProps> = ({ video }) => {
...
export default LikeDislikeQuestionButton;
